...
public class NotificationUtils {
    ...
    private static final int WATER_REMINDER_IGNORE_INTENT_ID =  3243;
    /**
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context){
        ...
        PendingIntent pendingIntent = PendingIntent.getService(
                context,
                WATER_REMINDER_IGNORE_INTENT_ID,
                ignorReminderIntent,
                PendingIntent.FLAG_UPDATE_CURRENT);
        // Notification.Action(int icon, CharSequence title, PendingIntent intent)
        NotificationCompat.Action ignoreRemiderAction = new NotificationCompat.Action(R.drawable.ic_drink_notification,
                "No,Thanks",pendingIntent);
        return ignoreRemiderAction;
    }
