...
//  TODO (10) Add constant values to sync Sunshine every 3 - 4 hours
    private static final int SYN_TIME_IN_HOURS = 3;
    private static final int SYN_TIME_IN_SECOUNDS = (int) TimeUnit.HOURS.toSeconds(SYN_TIME_IN_HOURS);
    private static final int SYN_FLEXTIOM_SECOUNDS = SYN_TIME_IN_SECOUNDS;
...
//  TODO (12) Create a method to schedule our periodic weather sync
     ...
     */
    static void schedualFirebaseJobDispatcherSync (final Context context){
       Driver driver = new GooglePlayDriver(context);
       FirebaseJobDispatcher jobDispatcher = new FirebaseJobDispatcher(driver);
       // crete a job
       Job jobSunshineSyn = jobDispatcher.newJobBuilder()
               .setService(SunshineFirebaseJobService.class)    // get service
               .setTag(SUNSHINE_SYNC_TAG)      // get tag
               .setLifetime(Lifetime.FOREVER)
               .setRecurring(true)
               .setConstraints(Constraint.ON_ANY_NETWORK)
               .setTrigger(Trigger.executionWindow(SYN_TIME_IN_SECOUNDS, SYN_TIME_IN_SECOUNDS + SYN_FLEXTIOM_SECOUNDS))
               .setReplaceCurrent(true)
               .build();
       // schedule the job with the dispatcher
        jobDispatcher.schedule(jobSunshineSyn);
    }
...
//      TODO (13) Call the method you created to schedule a periodic weather sync
        schedualFirebaseJobDispatcherSync(context);
        /*
