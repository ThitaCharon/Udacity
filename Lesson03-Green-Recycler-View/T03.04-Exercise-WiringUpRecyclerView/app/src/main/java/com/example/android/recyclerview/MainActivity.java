...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNumnerslist = (RecyclerView) findViewById(R.id.rv_numbers);
        ...
        mNumnerslist.setAdapter(mAdapter);
