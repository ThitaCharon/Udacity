...
public class MainActivity extends AppCompatActivity implements ForecastAdapter.ForecastAdapterOnClickHandler, LoaderCallbacks<String[]> {
    ...
    private static final int LOADER_ID_FORECAST = 23;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //loadWeatherData();
        int loaderID = LOADER_ID_FORECAST;
        ...
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                try {
                    ...
                    String jsonWeatheRespond = NetworkUtils.getResponseFromHttpUrl(weatherUrl);
                    String[] jsonWeatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,jsonWeatheRespond);
...
//            loadWeatherData();
            invalidateData();
            getSupportLoaderManager().restartLoader(LOADER_ID_FORECAST,null,this);
            return true;
        }
