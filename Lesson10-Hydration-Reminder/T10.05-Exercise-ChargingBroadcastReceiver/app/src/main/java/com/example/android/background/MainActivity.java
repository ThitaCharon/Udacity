...
public class MainActivity extends AppCompatActivity implements
    ...
    IntentFilter mChangingIntentFilter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChangingIntentFilter = new IntentFilter();
        mChangingIntentFilter.addAction(Intent.ACTION_POWER_CONNECTED);
        mChangingIntentFilter.addAction(Intent.ACTION_POWER_DISCONNECTED);

        // instantiate for BroadcastReceiver and will modify it in onResum and onPause
    ...
    protected void onResume(){
        super.onResume();
        registerReceiver(mChargingReceiver,mChangingIntentFilter);
    }
    ...
    private class ChargingBroadcastReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            // want to call showCharging method but how to know the device is charging or not
