...
//            mSearchResultsTextView.setText(rawJsonSearchResults);
    ...
    private void makeGithubSearchQuery() {
        ...
        if (TextUtils.isEmpty(githubQuery)){
            mUrlDisplayTextView.setText("No User prompt");
            return;
        }
...
//        new GithubQueryTask().execute(githubSearchUrl);
        ...
        Loader<String> gitSearchLoader = loaderManager.getLoader(GITHUB_SEARCH_LOADER);
        if (gitSearchLoader == null){
    ...
    // TODO (3) Override onCreateLoader set to final so it can access from the inner class function
    @Override
...
//                 super.onStartLoading();
                ...
                // TODO (6) If args is null, return.     >> args is same as bundle
                if (bundle == null){
                    return;
                }
            ...
            public String loadInBackground() {
                ...
                String searchUrlString = bundle.getString(SEARCH_QUERY_URL_EXTRA);
