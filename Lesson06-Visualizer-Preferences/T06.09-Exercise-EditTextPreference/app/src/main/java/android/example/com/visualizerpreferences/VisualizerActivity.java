...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    //TODO create loadColorFromPreferences
    ...
    private void loadSizeFromSharedPreferences(SharedPreferences sharedPreferences){
        //get the text size scale value
        float size = Float.parseFloat(sharedPreferences.getString(getString(R.string.pref_textSize_key),
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            ...
            float textsize = Float.parseFloat(sharedPreferences.getString(getString(R.string.pref_textSize_key),getString(R.string.pref_textSize_default)));
            mVisualizerView.setMinSizeScale(textsize);
        }
    }
