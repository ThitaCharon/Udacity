...
public class SettingsFragment extends PreferenceFragmentCompat implements OnSharedPreferenceChangeListener {
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        // Preference is a root of Preferences so can count how many preference
        int count = preferenceScreen.getPreferenceCount();

        for(int i = 0; i< count;i++){
            Preference perf = preferenceScreen.getPreference(i);
            if (perf instanceof ListPreference){
                //if it a Listview
                String value = sharedPreferences.getString(perf.getKey(),"");
                System.out.print(value);
                setPreferenceSummary(perf,value);
            }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        // find preference by the key and check if it a Listpreference then setPreference summary
