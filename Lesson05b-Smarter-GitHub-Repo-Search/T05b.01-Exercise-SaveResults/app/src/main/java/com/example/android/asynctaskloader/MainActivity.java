...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            ...
            String rawJSONData = savedInstanceState.getString(SEARCH_RESULT_RAW_JSON);
            // the stores the string in both view
    ...
    // TODO (8) Using the key for the raw JSON search results, put the search results into the outState Bundle
        String rawJASONData = mSearchResultsTextView.getText().toString();
        outState.putString(SEARCH_RESULT_RAW_JSON,rawJASONData);
